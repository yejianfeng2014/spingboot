        ...
        try {
            for (int idx = 0; idx < this.text_parts.size(); idx++) {
                ...
                String url = GOOGLE_TTS_URL + "?"
                        + "ie=" + "UTF-8"
                        + "&" + "q=" + URLEncoder.encode(part, "UTF-8").replace("+", "%20")
                        + "&" + "tl=" + this.lang
                        + "&" + "ttsspeed=" + this.speed
...
// &tl=en&total=1&idx=0&textlen=4&tk=664831.830512&client=t&ttsspeed=0.24
                ...
                get.setHeader("Referer", "http://translate.google.cn/");
                ...
                if (httpEntity != null) {
                  ...
                  /*  httpEntity.writeTo( new BufferedOutputStream(new FileOutputStream(writename));
                    ...
                    File writename = new File(savedDir, "test.mp3");

                    BufferedOutputStream bfo = new BufferedOutputStream(new FileOutputStream(writename));
