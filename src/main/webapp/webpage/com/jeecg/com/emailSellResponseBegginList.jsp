...
<html>
<head>
	<title>email_sell_response_beggin</title>
...
<body style="background-color: #FFFFFF;">
	<div id="emailSellResponseBegginList" v-cloak>
		<!--工具条-->
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item>
			    	<el-button type="primary" icon="el-icon-search" v-on:click="getEmailSellResponseBeggins">查询</el-button>
			    </el-form-item>
			    <el-form-item>
		...
		<!--列表-->
		<el-table :data="emailSellResponseBeggins" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
...
<script>
	var vue = new Vue({			
		el:"#emailSellResponseBegginList",
		data() {
			return {
				filters: {
				},
		...
		methods: {
			handleSortChange(sort){
				...
				this.getEmailSellResponseBeggins();
			},
			...
			getEmailSellResponseBeggins() {
				...
				this.$http.get(this.url.list,para).then((res) => {
					...
					this.emailSellResponseBeggins = datas;
			...
			//导入
			ImportXls: function(){
				openuploadwin('Excel导入',this.url.ImportXls, "emailSellResponseBegginList");
			},
			//初始化数据字典
