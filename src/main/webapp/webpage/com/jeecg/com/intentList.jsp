...
<body style="background-color: #FFFFFF;">
	<div id="intentList" v-cloak>
		<!--工具条-->
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item>
			    	<el-button type="primary" icon="el-icon-search" v-on:click="getIntents">查询</el-button>
			    </el-form-item>
			    <el-form-item>
		...
		<!--列表-->
		<el-table :data="intents" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55"></el-table-column>
			<el-table-column type="index" width="60"></el-table-column>
			<el-table-column prop="intentName" label="意图名称" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="intentDetail" label="意图描述" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
		...
		<el-dialog :title="formTitle" fullscreen z-index="800" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form" size="mini">
					<el-form-item label="意图名称" prop="intentName">
						<el-input v-model="form.intentName" auto-complete="off" placeholder="请输入意图名称"></el-input>
					</el-form-item>
					<el-form-item label="意图描述" prop="intentDetail">
						<el-input v-model="form.intentDetail" auto-complete="off" placeholder="请输入意图描述"></el-input>
					</el-form-item>
			</el-form>
	...
	var vue = new Vue({			
		...
		data() {
			return {
				...
				url:{
					list:'${webRoot}/intentController.do?datagrid',
					del:'${webRoot}/intentController.do?doDel',
					batchDel:'${webRoot}/intentController.do?doBatchDel',
					queryDict:'${webRoot}/systemController.do?typeListJson',
					save:'${webRoot}/intentController.do?doAdd',
					edit:'${webRoot}/intentController.do?doUpdate',
					upload:'${webRoot}/systemController/filedeal.do',
					downFile:'${webRoot}/img/server/',
					exportXls:'${webRoot}/intentController.do?exportXls&id=',
					ImportXls:'${webRoot}/intentController.do?upload'
				},
				intents: [],
				total: 0,
				page: 1,
		...
		methods: {
			...
			getIntents() {
				...
				fields.push('id');
				fields.push('id');
				fields.push('intentName');
				fields.push('intentDetail');
				let para = {
					params: {
						page: this.page,
						rows: this.pageSize,
			...
			//导入
			ImportXls: function(){
				openuploadwin('Excel导入',this.url.ImportXls, "intentList");
			},
			//初始化数据字典
