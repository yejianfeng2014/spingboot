...
<body style="background-color: #FFFFFF;">
	<div id="rawDataLogList" v-cloak>
		<!--工具条-->
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item style="margin-bottom: 8px;" prop="rawText">
					<el-input v-model="filters.rawText" auto-complete="off" placeholder="请输入收到的内容"></el-input>
				</el-form-item>
				<el-form-item style="margin-bottom: 8px;" prop="sourceType">
					<el-input v-model="filters.sourceType" auto-complete="off" placeholder="请输入数据来源"></el-input>
				</el-form-item>
				<el-form-item style="margin-bottom: 8px;" prop="insertDate">
					<el-input v-model="filters.insertDate" auto-complete="off" placeholder="请输入插入时间"></el-input>
				</el-form-item>
				<el-form-item>
			    	<el-button type="primary" icon="el-icon-search" v-on:click="getRawDataLogs">查询</el-button>
			    </el-form-item>
			    <el-form-item>
		...
		<!--列表-->
		<el-table :data="rawDataLogs" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55"></el-table-column>
			<el-table-column type="index" width="60"></el-table-column>
			<el-table-column prop="rawText" label="收到的内容" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="sourceType" label="数据来源" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="insertDate" label="插入时间" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
		...
		<el-dialog :title="formTitle" fullscreen z-index="800" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form" size="mini">
					<el-form-item label="收到的内容" prop="rawText">
						<el-input v-model="form.rawText" auto-complete="off" placeholder="请输入收到的内容"></el-input>
					</el-form-item>
					<el-form-item label="数据来源" prop="sourceType">
						<el-input v-model="form.sourceType" auto-complete="off" placeholder="请输入数据来源"></el-input>
					</el-form-item>
					<el-form-item label="插入时间" prop="insertDate">
						<el-input v-model="form.insertDate" auto-complete="off" placeholder="请输入插入时间"></el-input>
					</el-form-item>
			</el-form>
	...
	var vue = new Vue({			
		...
		data() {
			return {
				...
				url:{
					list:'${webRoot}/rawDataLogController.do?datagrid',
					del:'${webRoot}/rawDataLogController.do?doDel',
					batchDel:'${webRoot}/rawDataLogController.do?doBatchDel',
					queryDict:'${webRoot}/systemController.do?typeListJson',
					save:'${webRoot}/rawDataLogController.do?doAdd',
					edit:'${webRoot}/rawDataLogController.do?doUpdate',
					upload:'${webRoot}/systemController/filedeal.do',
					downFile:'${webRoot}/img/server/',
					exportXls:'${webRoot}/rawDataLogController.do?exportXls&id=',
					ImportXls:'${webRoot}/rawDataLogController.do?upload'
				},
				rawDataLogs: [],
				total: 0,
				page: 1,
		...
		methods: {
				...
				let para = {
					params: {
						...
						order:this.sort.order,
					 	rawText:this.filters.rawText,
					 	sourceType:this.filters.sourceType,
					 	insertDate:this.filters.insertDate,
						field:fields.join(',')
					}
				};
			...
			//导入
			ImportXls: function(){
				openuploadwin('Excel导入',this.url.ImportXls, "rawDataLogList");
			},
			//初始化数据字典
