...
<body style="background-color: #FFFFFF;">
	<div id="tEmailList" v-cloak>
		<!--工具条-->
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item>
			    	<el-button type="primary" icon="el-icon-search" v-on:click="getTEmails">查询</el-button>
			    </el-form-item>
			    <el-form-item>
		...
		<!--列表-->
		<el-table :data="tEmails" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55"></el-table-column>
			<el-table-column type="index" width="60"></el-table-column>
			<el-table-column prop="title" label="邮件标题" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="content" label="邮件正文" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="beizhu" label="汉语标注" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="biaoji" label="标记" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
		...
		<el-dialog :title="formTitle" fullscreen z-index="800" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form" size="mini">
					<el-form-item label="邮件标题" prop="title">
						<el-input v-model="form.title" auto-complete="off" placeholder="请输入邮件标题"></el-input>
					</el-form-item>
					<el-form-item label="汉语标注" prop="beizhu">
						<el-input v-model="form.beizhu" auto-complete="off" placeholder="请输入汉语标注"></el-input>
					</el-form-item>
					<el-form-item label="标记" prop="biaoji">
						<el-input v-model="form.biaoji" auto-complete="off" placeholder="请输入标记"></el-input>
					</el-form-item>
	...
	var vue = new Vue({			
		...
		data() {
			return {
				...
				url:{
					list:'${webRoot}/tEmailController/datagrid?',
					del:'${webRoot}/tEmailController/doDel?',
					batchDel:'${webRoot}/tEmailController/doBatchDel?',
					queryDict:'${webRoot}/systemController/typeListJson?',
					save:'${webRoot}/tEmailController/doAdd?',
					edit:'${webRoot}/tEmailController/doUpdate?',
					upload:'${webRoot}/systemController/filedeal.do',
					downFile:'${webRoot}/img/server/',
					exportXls:'${webRoot}/tEmailController/exportXls&id=',
					ImportXls:'${webRoot}/tEmailController/upload'
				},
				tEmails: [],
				total: 0,
				page: 1,
		...
		methods: {
			...
			//导入
			ImportXls: function(){
				openuploadwin('Excel导入',this.url.ImportXls, "tEmailList");
			},
			//初始化数据字典
